class SportClub:
    ...
    def __eq__(self, o: object) -> bool:
        ...
        """
        if type(o) is SportClub and o.getCity() == self.getCity() and o.getName() == self.getName() and o.getSport() == self.getSport():
            return True
        else:
            return False
    ...
    def __lt__(self, o: object) -> bool:
        ...
        """
        if type(o) is SportClub and o.getName() < self.getName() and o.getCity() < self.getCity() and o.getSport() < self.getSport():
            return True
        else:
            return False
        # TODO: Complete the function, which can be useful for ordering a List of Sportclub objects
